...
project.extra["GithubUrl"] = "https://github.com/Hermetic-Order-of-the-Decorative-Egg/plugins-of-the-egg"
...
subprojects {
    ...
    project.extra["PluginProvider"] = "orderoftheegg"
    ...
    repositories {
        ...
        exclusiveContent {
            ...
            filter {
                ...
                includeGroupsByRegex("com\\.illumine.*")
            }
        }
    }
